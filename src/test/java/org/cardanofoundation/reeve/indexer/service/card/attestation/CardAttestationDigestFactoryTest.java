...
/**
 * Contract test for {@link CardAttestationDigestFactory} — the platform's future import verification
 * recomputes this SAME digest from an imported card file, so this formula must never change silently.
 * See {@link CardAttestationDigestFactory}'s own javadoc for the formula this pins.
 */
class CardAttestationDigestFactoryTest {
    ...
    void digestOfIsAStableGoldenVectorForAFixedCard() {
        ...
        // this literal means the formula changed — cross-check against the platform's import
        // verification before updating it.
    ...
    void toCardJsonFieldSetWithAllOptionalFieldsPresentMatchesExactlyWhatTheDigestCovers() {
        ...
        card.setAttestationKelSequence("3");
        card.setAttestationKelEventSaid("EKELEVENT");
    ...
    void attestationFieldsOnTheCardRowDoNotAffectTheDigest() {
        ...
        attested.setAttestationKelEventSaid("EKELEVENT");
