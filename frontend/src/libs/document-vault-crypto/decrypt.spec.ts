...
describe('document-vault crypto KAT (shared with the Reeve frontend)', () => {
  ...
  it('skips a slot with malformed ephemeral_pub hex instead of throwing (I6)', async () => {
  ...
  it('rejects an unknown envelope version (I7)', async () => {
  ...
  it('rejects an envelope with the wrong type (I7)', async () => {
