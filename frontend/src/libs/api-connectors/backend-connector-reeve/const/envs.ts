...
// Document detail (§9.5): explorer + IPFS gateway URL bases are frontend deployment config, not
// contract-frozen values - each deployment points at whichever explorer/gateway it trusts.
