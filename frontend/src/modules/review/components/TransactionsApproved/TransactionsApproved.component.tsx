...
import { TableBatchReviewApproved } from 'modules/review/components/TableBatchReviewApproved/TableBatchReviewApproved.component.tsx'
...
export const TransactionsApproved = () => {
  ...
  return <TableBatchReviewApproved data={batch} pagination={{ handlePagination }} sorting={{ handleSorting }} isFetching={isFetching} />
}
