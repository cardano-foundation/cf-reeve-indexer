...
interface DashboardToolTemplateReadOnlyProps {
  data: ChartsData
  options?: undefined
...
interface DashboardToolTemplateWriteProps {
  data: ChartsData
  options: SlotOption[]
  selection: TemplateSlotSelections<Slots> | null
...
export type DashboardToolTemplateProps = DashboardToolTemplateReadOnlyProps | DashboardToolTemplateWriteProps
