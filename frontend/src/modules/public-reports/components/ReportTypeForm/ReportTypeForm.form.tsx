...
import { AlertView } from 'modules/public-reports/components/AlertView/AlertView.component.tsx'
import { AssetsGroup } from 'modules/public-reports/components/AssetsGroup/AssetsGroup.component.tsx'
import { IncomeGroup } from 'modules/public-reports/components/IncomeGroup/IncomeGroup.component.tsx'
import { LiabilitiesAndFoundationCapitalGroup } from 'modules/public-reports/components/LiabilitiesAndFoundationCapitalGroup/LiabilitiesAndFoundationCapitalGroup.component.tsx'
...
import { BalanceSheetFormErrorValues, IncomeStatementFormErrorValues } from 'modules/public-reports/hooks/useReportTypeForm.ts'
import { BalanceSheetWarnings, IncomeStatementWarnings } from 'modules/public-reports/hooks/useReportValidate.ts'
import { validateCrossReportProfit } from 'modules/public-reports/utils/validations.ts'
        ...
        <>
          ...
          {(balance || isCrossReportProfitEqual) && (
            <Box display="flex" flexDirection="column" gap={3} mt={5}>
              ...
              {isCrossReportProfitEqual && <AlertView message={t({ id: 'profitForTheYearMismatchWarningMessage' })} report={reportOfOppositeType} severity="warning" />}
            </Box>
          )}
      ...
      {!isPresentationMode && (
        <>
          ...
          {isCrossReportProfitEqual && (
            <Box display="flex" flexDirection="column" gap={3} mt={5}>
              <AlertView message={t({ id: 'profitForTheYearMismatchWarningMessage' })} report={reportOfOppositeType} severity="warning" />
            </Box>
          )}
          <Grid container justifyContent="flex-end" mt={5} spacing={1}>
            <Grid>
