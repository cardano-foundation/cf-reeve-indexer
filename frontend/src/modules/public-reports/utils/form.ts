import { BalanceSheetDetailsApiResponse, IncomeStatementDetailsApiResponse } from 'libs/api-connectors/backend-connector-reeve/api/reports/publicReportsApi.types'
import { formatNumber } from 'libs/utils/format.ts'

export const getBalanceSheetInitialValues = (report: BalanceSheetDetailsApiResponse) => ({
...
export const getIncomeStatementInitialValues = (report: IncomeStatementDetailsApiResponse) => ({
