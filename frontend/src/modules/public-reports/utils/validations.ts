import { BalanceSheetDetailsKeys, IncomeStatementDetailsKeys, ReportApiResponse, ReportType } from 'libs/api-connectors/backend-connector-reeve/api/reports/publicReportsApi.types'
...
import { getTotalIncome } from 'modules/public-reports/utils/calculations.ts'
