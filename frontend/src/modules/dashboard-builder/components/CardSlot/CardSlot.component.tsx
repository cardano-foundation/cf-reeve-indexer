...
import { CardStyled, CardActionsStyled, CardContentStyled, IconStyled, MenuStyled, MenuItemStyled } from 'modules/dashboard-builder/components/CardSlot/CardSlot.styles.tsx'
...
import { SlotOption } from 'modules/dashboard-builder/types'
