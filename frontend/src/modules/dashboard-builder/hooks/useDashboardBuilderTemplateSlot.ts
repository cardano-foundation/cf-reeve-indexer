...
import { SlotOption, SlotOptionId, Slots, SlotType, Template, TemplateSlotSelections } from 'modules/dashboard-builder/types'
import { getDefaultSelection, getDefaultTemplateSlots } from 'modules/dashboard-builder/utils/templateSlot.ts'
...
interface DashboardBuilderTemplateSlotState {
  dashboard: GetDashboardsResponse | null
  template: Template
}

export const useDashboardBuilderTemplateSlot = (state: DashboardBuilderTemplateSlotState) => {
