...
import { DEFAULT_SEARCH_FILTERS_VALUES } from 'modules/public-events/components/SearchFilters/SearchFilters.consts'
...
const SearchActionControls = () => {
  ...
  return (
    <TableToolbar.ActionControls>
      <ToggleButtonGroup aria-label="Public events toolbar control actions" value={type}>
